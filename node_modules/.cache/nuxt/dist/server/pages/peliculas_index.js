...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"container"},[_c('HeaderView'),_vm._ssrNode(" <h3 style=\"margin-top: 15px\">Información de Películas</h3> <p>Esta sección presenta información sobre películas</p> "),_vm._ssrNode("<ul>","</ul>",_vm._l((_vm.peliculas),function(pelicula){return _vm._ssrNode("<li>","</li>",[_c('NuxtLink',{attrs:{"to":{ name: 'peliculas-slug', params: { slug: pelicula.slug } }}},[_vm._v(_vm._s(pelicula.title))])],1)}),0),_vm._ssrNode(" "),_c('FooterView')],2)}
var staticRenderFns = []
